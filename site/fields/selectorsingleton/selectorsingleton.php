 ...
 */
class SelectorSingletonField extends BaseField
{
    ...
    public function files()
    {
        ...
        // Falls kein Bild da ist -> Teaserpool nutzen
        if($files->count() == 0){
            $files = (site()->find("_shared/uebergreifende-informationen"))? site()->find("_shared/uebergreifende-informationen")->files() : false;
            //$teaserpool = site()->find("_shared/uebergreifende-informationen");
        }
     ...
     * @return bool
     */
    public function isInValue($filename)
    {
        return in_array($filename, $this->value());
    }
