...
kirbytext::$tags['vimeoResponsive'] = array(
	'html' => function($tag) {
		$url   = $tag->attr("vimeoResponsive");
		...
		return '<div class="video-container"><iframe' . $class . ' src="' . $url . '?api=1&player_id='.$id.'" width="' . $params['width'] . '" height="' . $params['height'] . '" id="'.$id.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>';
