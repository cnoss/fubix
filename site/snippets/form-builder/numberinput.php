...
<div class="form-builder-wrap">
	...
	<fieldset class="form-builder-preview">
		<input type="number" disabled="disabled" name="<?=$data->name();?>" required="<?=$data->required();?>">
...
<div class="form-group">
	...
	<div class="<?=$classes["data"];?>"><input class="form-control" type="number" name="<?=$formfield->name(); ?>" ></div>
